...
@.List_vtable = global [11 x i8*] [i8* bitcast (i1 (i8*)* @List.Init to i8*), i8* bitcast (i1 (i8*,i32,i32,i32)* @List.test to i8*), i8* bitcast (i1 (i8*,i8*,i8*,i1)* @List.InitNew to i8*), i8* bitcast (i8* (i8*,i8*)* @List.Insert to i8*), i8* bitcast (i1 (i8*,i8*)* @List.SetNext to i8*), i8* bitcast (i8* (i8*,i8*)* @List.Delete to i8*), i8* bitcast (i32 (i8*,i8*)* @List.Search to i8*), i8* bitcast (i1 (i8*)* @List.GetEnd to i8*), i8* bitcast (i8* (i8*)* @List.GetElem to i8*), i8* bitcast (i8* (i8*)* @List.GetNext to i8*), i8* bitcast (i1 (i8*)* @List.Print to i8*)]
...
define i32 @main(){
	%_0 = call i8* @calloc(i32 1, i32 49)
...
{	%other = alloca i8*
	...
	%_16 = call i1 %_11(i8* %this, i32 %_12, i32 %_15)	%_17= xor i1 1, %_16
...
if1:
	...
	%_34 = call i1 %_29(i8* %this, i32 %_30, i32 %_33)	%_35= xor i1 1, %_34
...
if6:
	...
	%_45 = call i1 %_44(i8* %_39)	%_46= xor i1 1, %_45
    br  i1 %_46, label %if8, label %if9
...
define i1 @List.test(i8* %this, i32 %.u, i32 %.a, i32 %.f)
{	%u = alloca i32
	store i32 %.u, i32* %u
	%a = alloca i32
	store i32 %.a, i32* %a
...
{	%new_elem = alloca i8*
	...
	%_0 = call i8* @calloc(i32 1, i32 119)
	%_1 = bitcast i8* %_0 to i8***
	%_2 = getelementptr [11 x i8*], [11 x i8*]* @.List_vtable, i32 0, i32 0
	store i8** %_2, i8*** %_1
...
andexpre1:
	br i1 %_8, label %andexpre2, label %andexpre4
...
andexpre4:
	%_11 = phi i1 [0, %andexpre1], [ %_10, %andexpre3 ]
...
if2:
	...
	%_24 = load i8**,i8*** %_23
	%_25 = getelementptr i8*,i8** %_24, i32 9
	%_26 = load i8*, i8** %_25
...
if6:
	...
	%_64 = load i8**,i8*** %_63
	%_65 = getelementptr i8*,i8** %_64, i32 8
	%_66 = load i8*, i8** %_65
...
loop1:
	...
	%_7= xor i1 1, %_6
	 br i1 %_7, label %loop2, label %loop3
...
if2:
	...
	%_18 = load i8**,i8*** %_17
	%_19 = getelementptr i8*,i8** %_18, i32 9
	%_20 = load i8*, i8** %_19
...
loop2:
	...
	%_17 = load i8**,i8*** %_16
	%_18 = getelementptr i8*,i8** %_17, i32 9
	%_19 = load i8*, i8** %_18
...
{	%head = alloca i8*
	...
	%_25 = call i8* @calloc(i32 1, i32 31)
	...
	%_50 = call i8* @calloc(i32 1, i32 31)
	...
	%_63 = load i8**,i8*** %_62
	%_64 = getelementptr i8*,i8** %_63, i32 3
	%_65 = load i8*, i8** %_64
	...
	%_71 = load i8**,i8*** %_70
	%_72 = getelementptr i8*,i8** %_71, i32 10
	%_73 = load i8*, i8** %_72
	...
	%_76 = call i8* @calloc(i32 1, i32 31)
	...
	%_88 = load i8**,i8*** %_87
	%_89 = getelementptr i8*,i8** %_88, i32 3
	%_90 = load i8*, i8** %_89
	...
	%_101 = call i8* @calloc(i32 1, i32 31)
	...
	%_110 = call i1 %_109(i8* %_104, i32 27)
	...
	%_127 = call i8* @calloc(i32 1, i32 31)
	...
	%_136 = call i1 %_135(i8* %_130, i32 28)
	...
	%_140 = getelementptr i8*,i8** %_139, i32 3
	...
	%_148 = getelementptr i8*,i8** %_147, i32 10
	...
	%_155 = getelementptr i8*,i8** %_154, i32 5
	...
	%_163 = getelementptr i8*,i8** %_162, i32 10
	...
	%_170 = getelementptr i8*,i8** %_169, i32 5
	...
	%_180 = bitcast i8* %_179 to i1 (i8*,i32,i32,i32)*
	%_181 = load i32, i32* %i

	%_182 = call i1 %_180(i8* %_175, i32 %_181)
